...
;;;###autoload
(defun njk/nix-format-buffer (orig-fun &rest buf)
...
(advice-add 'nix--format-call :around #'njk/nix-format-buffer)

;; TODO:
;; (defun +nix/find-repl-args (&optional flakeroot)
;;   "Search for a repl.nix file inside FLAKEROOT to load into the repl."
;;   (let ((is-devshell (getenv "FLAKEROOT")))))
